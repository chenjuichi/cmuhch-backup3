...
IPAddress local_IP(10,108,249,101);
...
void loop() {
  ...
  if (currentMillis_MQTT - previousMillis_MQTT >= intervalMQTT) {
   ...
   String myStr="hello station1, The UUID number is " + uuidStr;
  ...
  if (ledFlash) {
    ...
    String strLedFlash("Station1 led flash ");        // 初始化字串
...
void reconnect() {
  ...
  while (!mqttClient.connected()) {
    ...
    if (mqttClient.connect(clientId.c_str(), NULL, NULL)) {
      ...
      mqttClient.publish("reconnect", "hello, station1...");
      // ... and resubscribe
