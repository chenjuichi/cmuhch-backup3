...
//const char* mqttServer = "192.168.50.100";

// Set your Static IP address
IPAddress local_IP(10,108,249,102);
...
void loop() {
  ...
  if (currentMillis_MQTT - previousMillis_MQTT >= intervalMQTT) {
   ...
   String myStr="hello station2, The UUID number is " + uuidStr;
  ...
  if (ledFlash) {
    ...
    String strLedFlash("Station2 led flash ");        // 初始化字串
...
void connectMQTTserver(){
  // 客户端ID
  int stateCode;
  String clientId = "CLIENT-esp8266-2";
...
void reconnect() {
  ...
  while (!mqttClient.connected()) {
    ...
    if (mqttClient.connect(clientId.c_str(), NULL, NULL)) {
      ...
      mqttClient.publish("reconnect", "hello, station2...");
      // ... and resubscribe
