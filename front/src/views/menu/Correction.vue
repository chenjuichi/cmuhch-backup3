    ...
    <v-row align="center" justify="center" v-if="currentUser.perm >= 1">
      <v-card width="100vw" class="pa-md-4 mt-5 mx-lg-auto">
        ...
        >
          <template v-slot:top>
              <v-toolbar flat>
                <v-toolbar-title>校正記錄查詢</v-toolbar-title>
...
export default {
  ...
  mounted() {
    console.log("Correction, mounted()...");
  ...
  computed: {
    headers () {
      return [
        { text: '資材碼', sortable: true, value: 'reqRecord_reagID', width: '6%', },
        { text: '品名', sortable: true, value: 'reqRecord_reagName', width: '12%',},
        { text: '供應商', sortable: true, value: 'reqRecord_supplier', width: '9%',},
        { text: '資材類別', sortable: true, value: 'reqRecord_prdName', width: '8%',},
        { text: '組別', sortable: true, value: 'reqRecord_catalog', width: '7%' },
        { text: '批次', sortable: false, value: 'reqRecord_stockInBatch', width: '6%', },
        { text: '入庫日期', sortable: true, value: 'reqRecord_stockInDate', width: '8%' },
        { text: '人員', sortable: true, value: 'reqRecord_stockInEmployer', width: '5%' },
        { text: '在庫數', sortable: false, value: 'reqRecord_cnt', width: '5%' },
        { text: '格位', sortable: false, value: 'reqRecord_stockInGrid', width: '6%' },

        { text: '盤點日期', sortable: true, value: 'reqRecord_inventoryDate', width: '8%',
          filter: value => {
        ...
        { text: '人員', sortable: true, value: 'reqRecord_inventoryEmployer', width: '5%',},
        { text: '盤點數', sortable: false, value: 'reqRecord_cnt_inv_mdf', width: '5%' },
        { text: '說明', sortable: true, value: 'reqRecord_comment', width: '10%' },
      ]
    },
  ...
  methods: {
    ...
    listCorrections() {    //從後端讀取dataTable的資料
      const path = '/listCorrections';
      console.log("Correction, listCorrections, Axios get data...")
      axios.get(path)
      .then((res) => {
    ...
    exportToExcel() {
      console.log("Correction, exportToExcel, Axios post data...")
      ...
      let obj= {
        ...
        reqRecord_prdName:'資材類別',
        reqRecord_catalog: '組別',
        reqRecord_stockInBatch: '批次',
        reqRecord_stockInDate: '入庫日期',
        reqRecord_stockInEmployer: '入庫人員',
        reqRecord_cnt: '在庫數',
        reqRecord_stockInGrid: '格位',
        reqRecord_inventoryDate: '盤點日期',
        reqRecord_inventoryEmployer: '盤點人員',
        reqRecord_cnt_inv_mdf: '盤點數',
        reqRecord_comment: '說明',
