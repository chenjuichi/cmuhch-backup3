  ...
  computed: {
    headers () {
      return [
        ...
        { text: '資材組別', sortable: true, value: 'reqRecord_catalog', width: '11%' },
        ...
        { text: '領料人員', sortable: false, value: 'reqRecord_Employer', width: '10%',},
        //{ text: '領用單位', sortable: false, value: 'reag_Out_unit', width: '15%' },
        { text: '領料數量', sortable: false, value: 'reqRecord_cnt', width: '12%' },
      ]
    },
